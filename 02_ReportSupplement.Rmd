...
for (assay_type in qc_assay_types) {
  ...
  if ("vsn" %in% effective_normalizations & !"combat" %in% effective_normalizations){
    ...
    cat("##### The heatmap shows Log2-transformed values of the integrated signal. Each row is a phosphosite and each column is a PamChip array. Rows are sorted by row mean and only include phosphosites which passed the QC.")
  }
  cat("  \n")
}
