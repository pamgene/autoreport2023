...
cat("* **Kinome Tree**, useful to group the kinases into phylogenetic families. The Coral Trees show all kinases above Kinase Score > ", params$fscore_thr, " and ", if(params$csUKA) "Specificity Score" else "Mean Specificity Score", " > ", params$spec_thr, ". You can also generate and fine tune your own [Coral Trees](http://phanstiel-lab.med.unc.edu/CORAL/).")
```
...
For more details of the algorithm and the scores, refer to the [UKA Flyer](https://pamgene.com/wp-content/uploads/2024/08/Flyer_PamGene-Upstream-Kinase-Analysis-Tool.pdf). 
...
data.frame("Deliverable" = c("Excel tables with all data: DATA FILES folder", "What’s in Main Report", 
          ...
          "Top kinases" = c("Filenames starting with UKA.", 
                            paste0("Top 10 significant (", ifelse(params$csUKA, "Final Score", "Median Final Score"), " > ", params$fscore_thr, " and ", ifelse(params$csUKA, "Specificity Score", "Mean Specificity Score"), " > ", params$spec_thr, ") kinases with differential activity in Test vs Control."), 
